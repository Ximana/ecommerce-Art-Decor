...
SECRET_KEY = 'django-insecure-y78vv#0z)8a8n)+%z@!!&%jj0r=^p@qd82lotorsw%2*%euj)v'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Pre-processador para contagem de intens do carrinho
                'apps.carrinhos.context_processors.carrinho_contador',
            ],
        },
    },
]
